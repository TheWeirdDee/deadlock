      ...
      <aside className="hidden lg:flex flex-col w-64 border-r border-white/10 glass-card m-4 mr-0 rounded-r-none h-[calc(100vh-32px)]">
        ...
        <div className="p-4 border-t border-white/10 bg-black/20">
          ...
          {userData ? (
            ...
            <button onClick={handleLogin} className="w-full text-xs bg-white text-black py-2 rounded font-bold uppercase tracking-widest hover:bg-gray-200 transition-colors">Connect</button>
          )}
        </div>
      </aside>
