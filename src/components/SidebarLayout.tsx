    ...
    <main className="flex min-h-screen bg-black text-white font-space relative overflow-hidden">
      ...
      {userData ? (
        ...
        <div className="absolute top-6 left-6 z-50">
          <Link href="/" className="flex items-center gap-3 group px-4 py-2 bg-black/50 backdrop-blur-md rounded-full border border-white/10 hover:border-white/30 transition-colors">
            <div className="w-5 h-5 bg-purple-500 rotate-45 flex items-center justify-center transition-transform duration-500 group-hover:rotate-[225deg]">
              <div className="w-2.5 h-2.5 bg-black -rotate-45"></div>
            </div>
            <span className="text-sm font-bold tracking-widest text-gray-300 group-hover:text-white transition-colors">BACK TO HOME</span>
          </Link>
        </div>
      )}
